...
2 | Python basics | Quick start on Python | Slides
3 | Geometry | COMPAS geometry | Slides [Assignment](https://github.com/augmentedfabricationlab/afab_course/blob/master/03_geometry/README.md)
